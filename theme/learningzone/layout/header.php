<?php
   ...
   $html = theme_learningzone_get_html_for_settings($OUTPUT, $PAGE);
   ...
   if (!empty($PAGE->theme->settings->courseheading)) {
       $courseheading = theme_learningzone_get_setting('courseheading',true);
   } 
   else {
       $courseheading = '';
   }
   if (!empty($PAGE->theme->settings->coursetagline)) {
       $coursetagline = theme_learningzone_get_setting('coursetagline',true);
   } 
   else {
       $coursetagline = '';
   }
   if (!empty($PAGE->theme->settings->yourcourseheading)) {
       $yourcourseheading = theme_learningzone_get_setting('yourcourseheading',true);
   } 
   else {
       $yourcourseheading = '';
   }
   if (!empty($PAGE->theme->settings->yourcoursetagline)) {
       $yourcoursetagline = theme_learningzone_get_setting('yourcoursetagline',true);
   } 
   else {
       $yourcoursetagline = '';
   }
   ...
   $display_faculties = (empty($PAGE->theme->settings->displayfaculties) ||$PAGE->theme->settings->displayfaculties < 1) ? 0 : 1;
...
<html <?php echo $OUTPUT->htmlattributes(); ?>>
   <head>
      ...
      <style>
         ...
         src: url('<?php echo $CFG->wwwroot;?>/theme/learningzone/font/opensans-regular-webfont.eot');
         src: url('<?php echo $CFG->wwwroot;?>/theme/learningzone/font/opensans-regular-webfont.eot?#iefix') format('embedded-opentype'), url('<?php echo $CFG->wwwroot;?>/theme/learningzone/font/opensans-regular-webfont.woff') format('woff'), url('<?php echo $CFG->wwwroot;?>/theme/learningzone/font/opensans-regular-webfont.ttf') format('truetype'), url('<?php echo $CFG->wwwroot;?>/theme/learningzone/font/opensans-regular-webfont.svg#open_sansregular') format('svg');
         font-weight: normal;
         font-style: normal;
         }
         @font-face {
         font-family: 'OpenSans-Bold';
         src: url('<?php echo $CFG->wwwroot;?>/theme/learningzone/font/OpenSans-Bold_gdi.eot');
         src: url('<?php echo $CFG->wwwroot;?>/theme/learningzone/font/OpenSans-Bold_gdi.eot?#iefix') format('embedded-opentype'), url('<?php echo $CFG->wwwroot;?>/theme/learningzone/font/OpenSans-Bold_gdi.woff') format('woff'), url('<?php echo $CFG->wwwroot;?>/theme/learningzone/font/OpenSans-Bold_gdi.ttf') format('truetype'), url('<?php echo $CFG->wwwroot;?>/theme/learningzone/font/OpenSans-Bold_gdi.otf') format('opentype'), url('<?php echo $CFG->wwwroot;?>/theme/learningzone/font/OpenSans-Bold_gdi.svg#OpenSans-Bold') format('svg');
         font-weight: 700;
         font-style: normal;
         font-stretch: normal;
         ...
         src: url('<?php echo $CFG->wwwroot;?>/theme/learningzone/font/opensans-light-webfont.eot');
         src: url('<?php echo $CFG->wwwroot;?>/theme/learningzone/font/opensans-light-webfont.eot?#iefix') format('embedded-opentype'), url('<?php echo $CFG->wwwroot;?>/theme/learningzone/font/opensans-light-webfont.woff2') format('woff2'), url('<?php echo $CFG->wwwroot;?>/theme/learningzone/font/opensans-light-webfont.woff') format('woff'), url('<?php echo $CFG->wwwroot;?>/theme/learningzone/font/opensans-light-webfont.ttf') format('truetype'), url('<?php echo $CFG->wwwroot;?>/theme/learningzone/font/opensans-light-webfont.svg#open_sanslight') format('svg');
         font-weight: normal;
         font-style: normal;
         }
         @font-face {
         font-family: 'FontAwesome';
         src: url('<?php echo $CFG->wwwroot;?>/theme/learningzone/font/fontawesome-webfont.eot?v=4.6.3');
         src: url('<?php echo $CFG->wwwroot;?>/theme/learningzone/font/fontawesome-webfont.eot?#iefix&v=4.6.3') format('embedded-opentype'), url('<?php echo $CFG->wwwroot;?>/theme/learningzone/font/fontawesome-webfont.woff2?v=4.6.3') format('woff2'), url('<?php echo $CFG->wwwroot;?>/theme/learningzone/font/fontawesome-webfont.woff?v=4.6.3') format('woff'), url('<?php echo $CFG->wwwroot;?>/theme/learningzone/font/fontawesome-webfont.ttf?v=4.6.3') format('truetype'), url('<?php echo $CFG->wwwroot;?>/theme/learningzone/font/fontawesome-webfont.svg?v=4.6.3#fontawesomeregular') format('svg');
         font-weight: normal;
         font-style: normal;
         }
      </style>
